...
# Add the movie_recommend directory to the Python path
sys.path.append(os.path.join(os.path.dirname(__file__), 'movie_recommend'))

from movie_recommend.src.model import recommend, movies
...
with st.sidebar:
    ...
    st.markdown("### 🔗 Links")
    st.markdown("""
    - [Source Code](https://github.com/Abuzaid-01/movie-recommend)
    - [Developer](https://github.com/Abuzaid-01)
    """)
